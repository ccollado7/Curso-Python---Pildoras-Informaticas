...
while True: #Creo un bucle con sentencia True. Cuando se introducen 2 valores correctos entonces se sale del bucle while

	try: 
		op1 = int(input("Introduce el primer numero: "))
		op2 = int(input("Introduce el segundo numero: "))
		break #En caso que try sea True se ejecuta este break y se sale del loop while, caso contrario va al bloque de codigo except.
